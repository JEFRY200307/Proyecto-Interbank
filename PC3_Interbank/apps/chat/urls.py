...
from .views import chat_dashboard, chat_list, ChatBotAPIView, ConversacionesUsuarioAPIView, AlimentarBotAPIView
...
urlpatterns = [
    ...
    path('api/alimentar-bot/', AlimentarBotAPIView.as_view(), name='alimentar_bot_api'),  # Nueva ruta para alimentar al bot
]